...
class ReceptionistProfileScreen extends StatefulWidget {
  ...
  const ReceptionistProfileScreen({super.key, required this.onNavigateToTab});
...
class _ReceptionistProfileScreenState extends State<ReceptionistProfileScreen> {
  ...
  void _openProfileEditDialog() {
    showDialog(
      context: context,
      builder: (_) => _ReceptionistProfileEditDialog(
        fullName: _fullName,
        email: _email,
...
class _ReceptionistAuthDialogCard extends StatelessWidget {
  final String title;
  final Widget child;

  const _ReceptionistAuthDialogCard({required this.title, required this.child});
...
class _ReceptionistOtpDialog extends StatefulWidget {
  final String email;
  final String purpose;
  final Future<void> Function() onResend;

  const _ReceptionistOtpDialog({required this.email, required this.purpose, required this.onResend});

  @override
  State<_ReceptionistOtpDialog> createState() => _ReceptionistOtpDialogState();
}

class _ReceptionistOtpDialogState extends State<_ReceptionistOtpDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return _ReceptionistAuthDialogCard(
      title: 'Verify OTP',
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
...
class _ReceptionistCreatePasswordDialog extends StatefulWidget {
  final String verificationToken;

  const _ReceptionistCreatePasswordDialog({required this.verificationToken});

  @override
  State<_ReceptionistCreatePasswordDialog> createState() => _ReceptionistCreatePasswordDialogState();
}

class _ReceptionistCreatePasswordDialogState extends State<_ReceptionistCreatePasswordDialog> {
...
class _ReceptionistProfileEditDialog extends StatefulWidget {
  ...
  @override
  State<_ReceptionistProfileEditDialog> createState() => _ReceptionistProfileEditDialogState();
}

class _ReceptionistProfileEditDialogState extends State<_ReceptionistProfileEditDialog> {
  ...
  Future<String?> _showOtpDialog({required String email, required String purpose}) {
    return showDialog<String>(
      ...
      builder: (_) => _ReceptionistOtpDialog(
        email: email,
        purpose: purpose,
  ...
  Future<void> _startChangePassword() async {
    ...
    final success = await showDialog<bool>(
      context: context,
      barrierDismissible: true,
      builder: (_) => _ReceptionistCreatePasswordDialog(verificationToken: token),
    );
    if (success == true) {
